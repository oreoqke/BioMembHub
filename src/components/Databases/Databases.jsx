    ...
    return (
        <div className='page-style'>
            ...
            <p>The {''} <a href={Databases.OPRLM}>OPRLM</a> {' '}
                ...
                Data bank (PDB)<sup>4</sup> of transmembrane TM and peripheral membrane proteins and 
                membrane-active peptides that are oriented in lipid membranes using the PPM 3.0 
                method<sup>2</sup>. OPM offers structural classification of proteins into families and 
                ...
                intracellular localization, interactive visualization by Jmol<sup>35</sup>, GLmol<sup>36</sup>, 
                LiteMol<sup>37</sup>, and iCn3D<sup>38</sup>, and links to related web resources, 
                PDB<sup>4</sup>, PDBsum<sup>39</sup>, MSD(PDBe)<sup>40</sup>, 
                TCDB<sup>41</sup>, PFAM<sup>42</sup>, UniProt<sup>43</sup>, SCOP<sup>44</sup>, 
                MMDB<sup>45</sup>, mpstruc<sup>32</sup>, MPDB<sup>46</sup>, and EncoMPASS<sup>47</sup>.  
            ...
            (from UniProt<sup>43</sup> and InterPro<sup>61</sup>), experimentally supported protein-protein 
            interactions (from HINT<sup>62</sup> and APID<sup>63</sup>), protein complexes 
            (from Reactome<sup>64</sup>, Complex Portal<sup>65</sup>, CORUM<sup>66</sup>, 
            and PDB<sup>4</sup>), pathways (from KEGG)<sup>67</sup> experimental 
            (from PDB<sup>4</sup>) and newly modeled 3D structures of bitopic protein domains and 
            protein complexes, mutagenesis data (from MutDB)<sup>68</sup>, and links to related bioinformatics 
            ...
            (<span className='bold'>Per</span>meability of {' '}
                ...
                <span className='bold'>M</span>embranes) {' '}
                database<sup>17</sup> collects experimental and calculated permeability 
